...
// LinkByNameWithBasicInfo mocks base method.
func (m *MockNetlinkLib) LinkByNameWithBasicInfo(name string) (netlink.Link, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LinkByNameWithBasicInfo", name)
	ret0, _ := ret[0].(netlink.Link)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// LinkByNameWithBasicInfo indicates an expected call of LinkByNameWithBasicInfo.
func (mr *MockNetlinkLibMockRecorder) LinkByNameWithBasicInfo(name any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LinkByNameWithBasicInfo", reflect.TypeOf((*MockNetlinkLib)(nil).LinkByNameWithBasicInfo), name)
}
